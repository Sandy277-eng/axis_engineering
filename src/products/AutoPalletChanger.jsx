...
const CATEGORY_ID = 'auto-pallet-changer';

export default function AutoPalletChanger() {
  ...
  const sizeFilters = ['All', ...categoryData.items.map(item => {
    if (item.size.includes('CVR')) return 'CVR Series';
    if (item.size.includes('SVR')) return 'SVR Series';
    return item.size;
  })];
  ...
  const filteredItems = selectedSize === 'All' 
    ...
    : categoryData.items.filter(item => {
        if (selectedSize === 'CVR Series') return item.size.includes('CVR');
        if (selectedSize === 'SVR Series') return item.size.includes('SVR');
      ...
      <section style={styles.heroSection}>
        ...
        <div style={styles.heroContent}>
          <div style={styles.breadcrumb}>
            ...
            <span style={styles.breadActive}> Auto Pallet Changers</span>
          </div>
                    ...
                    <div className="aishmo-card-content">
                      ...
                      <div className="aishmo-card-specs">
                        <div className="aishmo-spec-row">
                          <span className="aishmo-spec-key">Pallet Size</span>
                          <span className="aishmo-spec-val">{prod.specs['Pallet Size'] || 'N/A'}</span>
                        </div>
                        <div className="aishmo-spec-row">
                          <span className="aishmo-spec-key">Maximum Load</span>
                          <span className="aishmo-spec-val">{prod.specs['Maximum Load'] || 'N/A'}</span>
                        </div>
                        <div className="aishmo-spec-row">
                          <span className="aishmo-spec-key">Change Time</span>
                          <span className="aishmo-spec-val">{prod.specs['Pallet Change Time'] || 'N/A'}</span>
                        </div>
                      </div>
