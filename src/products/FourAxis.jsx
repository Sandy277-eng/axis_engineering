...
export default function FourAxis() {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* DETRON 4-AXIS OVERVIEW & TECHNOLOGY SECTION */}
      <section style={{ backgroundColor: '#ffffff', padding: '48px 24px', borderBottom: '1px solid #e2e8f0' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'left' }}>
          ...
          <h2 style={{ fontSize: '28px', fontWeight: '900', color: '#0f172a', margin: '8px 0 20px 0', lineHeight: '1.3' }}>
            Elevating Machining Performance: detron 4-Axis Rotary Tables by Axis Engineering
          </h2>
            ...
            <div style={{ flex: 1, display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '28px', fontSize: '15px', lineHeight: '1.75', color: '#334155' }}>
              <div style={{ backgroundColor: '#f8fafc', padding: '24px', borderRadius: '8px', borderLeft: '4px solid #E30613', boxShadow: '0 2px 10px rgba(0,0,0,0.03)' }}>
                <p style={{ margin: '0 0 16px 0' }}>
                  At <strong>Axis Engineering</strong>, we deliver Detron’s premier 4-axis rotary tables to empower vertical machining centers across India, breaking through 3-axis limitations to achieve a massive leap in production capacity. Featuring faceplate diameters from <strong>Ø125 mm to Ø800 mm</strong>, our 4-axis solutions seamlessly upgrade standard machines into high-efficiency multi-sided machining centers, drastically reducing repetitive workpiece re-clamping and eliminating human error.
                </p>
                <p style={{ margin: 0 }}>
                  Tailored for demanding manufacturing applications, our 4-axis lineup offers versatile drive technologies: the <strong>Dual-Lead Worm Gear Series</strong> for heavy-duty, high-torque cutting in automotive and machinery production; the zero-backlash <strong>Roller Cam Series</strong> for long-term mold and electronic component precision; and the <strong>Direct Drive Motor (DDM) Series</strong> for ultra-fast, zero-wear dynamic indexing.
                </p>
              </div>

              <div style={{ backgroundColor: '#f8fafc', padding: '24px', borderRadius: '8px', borderLeft: '4px solid #E30613', boxShadow: '0 2px 10px rgba(0,0,0,0.03)' }}>
                <p style={{ margin: '0 0 16px 0' }}>
                  The core advantage lies in Detron’s patented high-pressure clamping mechanism and large-diameter radial-axial bearings, ensuring rock-solid stability under intense cutting forces. This effectively suppresses chatter, protects cutting tools, and guarantees optimal surface finish during continuous heavy machining. Before delivery, all units undergo rigorous accuracy verification, meeting international positioning and repeatability standards.
                </p>
                <p style={{ margin: 0 }}>
                  Backed by Axis Engineering’s nationwide technical support, turnkey installation, and application engineering, implementing our 4-axis solutions helps manufacturers shorten cycle times by over 30%, delivering uncompromised precision and maximum spindle uptime.
                </p>
              </div>
            </div>
          </div>
